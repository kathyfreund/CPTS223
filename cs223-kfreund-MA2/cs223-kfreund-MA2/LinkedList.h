...
// START Microassigment zone - all code you need to change is here
	...
	// Copy constructor
	//  MA TODO: Implement!
	LinkedList(const LinkedList<T> &other) ///NEED TO WORK ON
	{
	...
	// Move constructor
	//  MA TODO: Implement! 
	LinkedList(LinkedList<T> &&other) ///DONE
	{
	...
	//  MA TODO: Implement!
	LinkedList(initializer_list<T> values) ///NEED TO WORK ON
	{
		cout << " [x] Initializer List Constructor executed. " << endl;
		// Add a copy of every element in values to ourselves
		_front = values._First;
		_end = values._Last;
		_size = values.size;
		///Missing two values? I'm not sure
	}
	...
	//  MA TODO: Implement!
	virtual LinkedList<T> &operator=(const LinkedList<T> &other) ///DONE (sorta?)
	{
		...
		if (this != &other) ///do we need to allocate new memory for these?
		{
			delete _front;
			_front = other._front;
	...
	//  MA TODO: Implement!
	virtual LinkedList<T> &operator=(LinkedList<T> &&other) ///DONE
	{
